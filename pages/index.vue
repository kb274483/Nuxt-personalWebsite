...
const getComponent = (name: string) => {
  switch (name) {
    ...
    case 'Code Works': return defineAsyncComponent(() => import('~/components/apps/Browser.vue'))
    case 'Gallery': return defineAsyncComponent(() => import('~/components/apps/Photos.vue'))
    case 'Settings': return defineAsyncComponent(() => import('~/components/apps/Settings.vue'))
